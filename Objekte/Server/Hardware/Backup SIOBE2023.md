...
| Feld                  | Inhalt        |
| --------------------- | ------------- |
| **Servername**        | SIOBE2023     |
| **IP-Adresse**        |               |
| **Standort**          | Keller links  |
| **Verantwortlicher**  |               |
| **Status**            | 🟢 In Betrieb |
...
| **Distribution/Version** | z.B. Ubuntu 22.04 LTS |
| **Kernel-Version** | |
| **Installationsdatum** | |
| **EOL-Datum** | |
...
| ---------------------------- | ------- | ------------------- |
| [[Veeam-Backup-Replication]] |         | Smart-Home Zentrale |
|                              |         |                     |
|                              |         |                     |
